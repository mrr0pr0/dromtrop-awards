-- Seed IT-Gullruten 2026 categories (Norwegian names)
INSERT INTO categories (name, description, is_active) VALUES
  ('Beste medieprodukt', 'Årets beste medieprodukt', true),
  ('Beste IT-produkt', 'Årets beste IT-produkt', true),
  ('Beste nettside', 'Årets beste nettside', true),
  ('Beste app', 'Årets beste app', true),
