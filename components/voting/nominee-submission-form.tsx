...
export function NomineeSubmissionForm({
  ...
  const visibleFields = useMemo(
    () => getVisibleNomineeFields(getCategoryName(categoryId, categories)),
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        setError(data.error || "Kunne ikke sende inn nominert.");
        return;
      }
      ...
      setVideoUrl("");
      setWhatWeMade("");
      setMessage("Nominasjonen er sendt inn og venter på godkjenning.");
    } catch {
